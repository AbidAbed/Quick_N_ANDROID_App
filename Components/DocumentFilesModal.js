...
function DocumentFilesModal({
  ...
  return (
    <View>
          ...
          <View
            ...
            {isVideo ? (
              <Video
                ...
                fullscreen={true}
                source={{
                  uri: `https://ee3d-41-45-192-105.ngrok-free.app/download/video/6611435f5b8590afd85a92b6`,
                }}
                controls={true}
                onLoad={onVideoLoad}
              ...
              <>
                {error !== null ? (
                  ...
                  <Image
                    ...
                    source={{
                      uri: `${BASE_BACKEND_URL}/message/file/binary?fileId=${fileObj._id}&page=${page}`,
                    }}
      ...
      {isAudio ? (
        <AudioPlayer
          src={`https://ee3d-41-45-192-105.ngrok-free.app/download/audio/661148209a9541e06455564e`}
          _id={fileObj._id}
          senderId={senderId}
          isHidden={isHidden}
        />
