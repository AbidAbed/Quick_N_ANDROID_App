      ...
      <View
        ...
        <View style={{width: '80%'}}>
          {config.map((configElement, index) => {
            return (
              <View key={index} style={[styleSingleField]}>
                <Label
                  text={configElement.lable}
                  style={[style.labelForm, configElement.styleLabel]}
                />
                ...
                <Input
                  ...
                  style={[style.inputForm, configElement.styleInput]}
        ...
        <View>
          <Text style={[{color: 'white', fontSize: 12}, errorStyle]}>
            {validationErrors}
          </Text>
          <Text style={[{color: 'white', fontSize: 12}, errorStyle]}>
